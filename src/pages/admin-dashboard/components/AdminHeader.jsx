...
const AdminHeader = ({ toggleSidebar, toggleDarkMode, isDarkMode }) => {
  ...
  return (
    <header className="bg-white shadow-sm py-4 px-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center">
          ...
          <div className="relative hidden md:block">
            <input
              type="text" placeholder="Search orders, users, inventory..." className="pl-10 pr-4 py-2 border border-neutral-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 w-64"
            />
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            <button className="relative p-2 text-neutral-600 hover:text-primary-600 transition duration-300">
          ...
          <div className="relative">
            ...
            {isProfileMenuOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg z-50 py-1">
                <Link 
                  to="/admin-profile" className="block px-4 py-2 text-neutral-700 hover:bg-neutral-100"
                >
                  Your Profile
                </Link>
                <Link 
                  to="/admin-settings" className="block px-4 py-2 text-neutral-700 hover:bg-neutral-100"
                >
                  Settings
                </Link>
      ...
      <div className="mt-4 relative lg:hidden">
        <input
          type="text" placeholder="Search orders, users, inventory..." className="pl-10 pr-4 py-2 border border-neutral-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 w-full"
        />
        <div className="absolute left-3 top-1/2 transform -translate-y-1/2 text-neutral-400">
          <Icon name="Search" size={18} />
        </div>
